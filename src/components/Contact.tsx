...
const Contact = () => {
  return (
    <section className="py-24 bg-gradient-to-br from-btl-800 via-btl-700 to-btl-600 text-white">
          ...
          <CardContent className="space-y-6">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="bg-white/10 border-white/30 text-white placeholder:text-btl-200"
                />
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  id="products" 
                  placeholder="t.ex. 5-10 produkter"
                  className="bg-white/10 border-white/30 text-white placeholder:text-btl-200"
                />
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button 
                size="lg" 
                className="bg-white text-btl-800 hover:bg-btl-50 hover-scale flex-1"
              >
                Boka demo
              </Button>
              <Button 
                variant="outline" 
                size="lg" 
                className="border-white text-white hover:bg-white/10 hover-scale flex-1"
              >
                Skicka förfrågan
              </Button>
            </div>
